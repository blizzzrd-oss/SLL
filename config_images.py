...
SCREEN_CLEARER_FRAME_SIZE = 16
SCREEN_CLEARER_FRAME_COUNT = 0
SCREEN_CLEARER_ANIMATION_FPS = 0

XP_MAGNET_SPRITE = "resources/images/pickabels/xp_magnet.png"
XP_MAGNET_FRAME_SIZE = 26
XP_MAGNET_FRAME_COUNT = 0
XP_MAGNET_ANIMATION_FPS = 0
