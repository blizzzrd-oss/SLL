...
from config import (
    REROLL_DICE_FRAME_SIZE, REROLL_DICE_FRAME_COUNT,
    REROLL_DICE_ANIMATION_FPS, REROLL_DICE_REROLL_CHARGES,
    XP_GREEN_FRAME_SIZE, XP_GREEN_FRAME_COUNT, 
    XP_GREEN_ANIMATION_FPS, XP_GREEN_XP_VALUE,
    XP_YELLOW_FRAME_SIZE, XP_YELLOW_FRAME_COUNT,
    XP_YELLOW_ANIMATION_FPS, XP_YELLOW_XP_VALUE,
    XP_LIGHT_BLUE_FRAME_SIZE, XP_LIGHT_BLUE_FRAME_COUNT,
    XP_LIGHT_BLUE_ANIMATION_FPS, XP_LIGHT_BLUE_XP_VALUE,
    XP_BLUE_FRAME_SIZE, XP_BLUE_FRAME_COUNT,
    XP_BLUE_ANIMATION_FPS, XP_BLUE_XP_VALUE,
    XP_RED_FRAME_SIZE, XP_RED_FRAME_COUNT,
    XP_RED_ANIMATION_FPS, XP_RED_XP_VALUE,
    XP_PURPLE_FRAME_SIZE, XP_PURPLE_FRAME_COUNT,
    ...
    SCREEN_CLEARER_FRAME_SIZE, SCREEN_CLEARER_FRAME_COUNT,
    SCREEN_CLEARER_ANIMATION_FPS, SCREEN_CLEARER_DROP_CHANCE,
    XP_MAGNET_FRAME_SIZE, XP_MAGNET_FRAME_COUNT,
    XP_MAGNET_ANIMATION_FPS, XP_MAGNET_DROP_CHANCE, XP_MAGNET_PULL_RADIUS
)
from config_images import (
    REROLL_DICE_SPRITE,
    XP_GREEN_SPRITE, XP_YELLOW_SPRITE, XP_LIGHT_BLUE_SPRITE,
    XP_BLUE_SPRITE, XP_RED_SPRITE, XP_PURPLE_SPRITE,
    SCREEN_CLEARER_SPRITE, XP_MAGNET_SPRITE
)
